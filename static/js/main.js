var heads = {
    "Aa":"Semester-I, 2020-2021",
    "Ab":"Semester-II, 2020-2021",
    "Ba":"Semester-II, 2019-2020",
    "Bb":"Semester-II, 2020-2021"
};
var data = {
    "Aa":{
        "1": {
        ...
        "2": {
            ...
            "Selected Students": "Gautam Vashishtha\nAbhiram Geddam"
        },
        "3": {
            "S. no": "3",
            "Name of Project": "Presentation slides on various campus features",
            "Mentor": "Prof. Gaurav Srivastava",
            "Desciption": "-",
            "Selected Students": "Jaspreet Singh"
        },
        "4": {
            "S. no": "4",
            "Name of Project": "Video making  on different campus features/practices",
            "Mentor": "Prof. Gaurav Srivastava",
            "Desciption": "-",
            "Selected Students": "Shubham Deshpande"
        },
        "5": {
            "S. no": "5",
            ...
            "Selected Students": "V P Shivasankaran\nMuhammad Yusuf Hassan"
        },
        "6": {
            "S. no": "6",
            ...
            "Mentor": "Prof. Jaison",
            "Desciption": "-",
            "Selected Students": "Mohamed Shamir\nKritika Kumawat\nGaurav Viramgami"
        },
        "7": {
            "S. no": "7",
    ...
    "Ab" :{
        ...
        "2": {
            ...
            "Selected Students": "Reuben Shibu Devanesan\nRishabh Gupta\nAditya Shekhar Sinha"
        },
        "3": {
            "Sr.No.": "3",
            "Name of Project": "Presentation slides on various campus features",
            "Mentor": "Prof. Gaurav Srivastava",
            "Desciption": "-",
            "Selected Students": "Ekata Lahiri"
        },
        "4": {
            "Sr.No.": "4",
            ...
            "Selected Students": "Akhilesh Chauhan\nDeep Samir Thakkar"
        },
        "5": {
            "Sr.No.": "5",
            ...
            "Selected Students": "Mohammed Aasim Shaikh\nPrateeti Rajjak"
        },
        "6": {
            "Sr.No.": "6",
        ...
        "7": {
            ...
            "Selected Students": "Abhavya Chandra\nShubham Deshpande"
        }
    },
    "Ba" :{
        "1": {
        ...
        "8": {
            ...
            "Project Details": "Design, development, and testing of De Laval Supersonic Nozzles to be used in a Fluidized Bed Jet Mill",
            "Incentives": "Certificate",
        ...
        "11": {
            ...
            "Project Details": "High aspect ratio functional inorganic nanoparticles for polymer reinforcement Applications",
            "Incentives": "Certificate",
            "Faculty Mentor": "Prof. Superb Misra",
            "Selected Students": "No one selected"
        },
        "12": {
            "Sr.No.": "12",
            "Company Name": "TATA Chemicals",
            "Project Details": "Develop poly-urea based elastomer coatings with value added surface functionalities such as anti-corrosion, self- healing & self-cleaning properties",
            "Incentives": "Certificate",
            "Faculty Mentor": "Prof. Abhijit Mishra",
            "Selected Students": "Dhruv Darda (19110012) and Dhananjay Singh (18110047)"
        },
        "13": {
            "Sr.No.": "13",
            "Company Name": "TATA Chemicals",
            "Project Details": "Synthesis of high purity 2,5-furandicarboxylic acid (FDCA) from glucose",
            "Incentives": "Certificate",
            "Faculty Mentor": "Prof. Sriram Kanvah Gundimeda",
            "Selected Students": "Parichay Thakore (17110098 and Vaibhav Khandare (18110180)"
        },
        "14": {
            "Sr.No.": "14",
            "Company Name": "TATA Chemicals",
            "Project Details": "Synthesis of high performance polymers like polyamides & explore potential applications",
            "Incentives": "Certificate",
            "Faculty Mentor": "Prof. Chinmay Ghoroi",
            "Selected Students": "Sumit Kumar (18110167)"
        },
        "15": {
            "Sr.No.": "15",
    ...
    "Bb" :{
        "1": {
            "Sr.No.": "1",
            "Company Name": "Honeywell ",
            "Project Details": "PERCEPTIBLE SENSING INTERFACE PLATFORM TO EASE EDGE ANALYTICS       https://drive.google.com/file/d/1WSpvMOZBx13BnIQT_Kn9C0WqJaN6u0dw/view?usp=sharing",
        ...
        "3": {
            "Sr.No.": "3",
            "Company Name": "Honeywell ",
            "Project Details": "Platform to enable plug and play capability to all identified digital output sensor and edge analytics. https://drive.google.com/file/d/1kb2RhIXjDh1ba4P4ftHK043yenlYndil/view?usp=sharing",
        ...
        "5": {
            "Sr.No.": "5",
            "Company Name": "Optimized solutions limited",
            "Project Details": "Board bring up and generic interfaces codes development over \nAltera Cyclone V series FPGA SoC - \n\nhttps://drive.google.com/file/d/1BHzoTSpWMumu5KnS9dQR5J0keO9pFLNC/view",
        ...
        "8": {
            "Sr.No.": "8",
            "Company Name": "Harsha Engineering",
        ...
        "11": {
            "Sr.No.": "11",
            "Company Name": "Intersect IQ",
            "Project Details": "Vehical Reversing\nhttps://drive.google.com/file/d/1s8NzPzNOBuIY35ubpJ5woE2zCfgvhRpl/view?usp=sharing",
        ...
        "16": {
            "Sr.No.": "16",
            "Company Name": "Dp Pulveriser",
            "Project Details": "Development of the Fluidized Bed Jet Mill\n\nhttps://drive.google.com/file/d/1cKWt2pP3y94-MRwVqMQ1-iwWsSOGn0Lo/view?usp=sharing",
            "Skills Required": "TBD",
        ...
        "17": {
            ...
            "Incentives": "Project can also be registered towards credited project course (4 credits) + Internship opportunity",
            "Faculty Mentor": "Prof. Ragavan K",
            "Selected Students": "No one was selected "
        },
        "18": {
            "Sr.No.": "18",
            "Company Name": "Hilti International",
...
$(document).ready(function () {
    ...
    $(".A").click(function(){
        ...
        mydata = data[ele];
        console.log(mydata)
        $(".cont>h2").text("Institute Building Projects");
        $(".cont>h4").text(heads[ele]);
    ...
    $(".B").click(function(){
        ...
        // console.log(ele)
        mydata = data[ele];
        $(".cont>h2").text("Industrial Projects");
        $(".cont>h4").text(heads[ele]);
        generatecardsIP(mydata);
    });

});


function generatecardsIBP(data) {
    // console.log(data);
    var html = "";
    ...
    for(key in data) {
        ...
        html+=data[key]["Selected Students"];
        html+='</p></div></div>'
      }
    $('#csv-display').append(html);
};

function generatecardsIP(data) {
    // console.log(data);
    var html = "";
    console.log(typeof(data));
    for(key in data) {
        ...
        html+='</p><p class="title">Skills Required</p><p class="skills">';
        var sk = data[key]["Skills Required"];
        ...
        html+='</p><p class="title">Incentive</p><p class="incentive">';
        html+=data[key]["Incentives"];
        html+='</p><p class="title">Faculty Mentor</p><p class="mentor">';
        html+=data[key]["Faculty Mentor"];
        html+='</p><p class="title">Selected Students</p><p class="students">';
        html+=data[key]["Selected Students"];
        html+='</p></div></div>'
      }
...
//     var html = '<table  class="table table-striped w-auto">';
